...
Outro motivo é que sem a taxação de lucros corporativos, **lucros retidos** poderiam se acumular livres de impostos eternamente dentro da firma, sendo distribuídos no futuro com tributação apenas no auferimento
...
Efeitos de uma taxação corporativa sem (a) e com (b) dedução para depreciação do capital: no 1o caso, ela diminui o produto marginal do capital, reduzindo o investimento; no 2o, o abatimento de gastos com *depreciação econômica* diminue o custo de financiamento, com efeito ambíguo `r Citep(myBib, "gruber")`
