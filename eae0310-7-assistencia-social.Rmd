...
No Brasil, os principais programas de transferência de renda para alívio da pobreza são, o Programa Bolsa Família (PBF), a partir de 2022 [Auxílio Brasil](https://www.gov.br/cidadania/pt-br/auxilio-brasil), e o Benefício de Prestação Continuada (BPC)

O PBF envolvia, até 2021: 
...
Finalmente, pobreza é extremamente *custosa psicologicamente* e torna tomar boas decisões mais difícil
...
Na verdade, a evidência é que transferências *reduzem* o consumo desses bens em 0.18 s.d. (plausivelmente pela redução de problemas psicológicos)
