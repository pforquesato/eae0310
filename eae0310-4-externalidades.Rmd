...
**Desconto hiperbólico:** pessoas preferem `$`100 hoje que `$`200 em 2 anos, mas preferem `$`200 em 8 anos que `$`100 em 6

Outra evidência é a demanda por **instrumentos de comprometimento** &mdash; por exemplo, poupança compulsória ou anuidade em academia
