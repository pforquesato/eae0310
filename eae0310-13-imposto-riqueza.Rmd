...
O imposto sobre riqueza $\tau$ só entra na decisão do agente por $W_{\text{ex-post}}$: se a aversão absoluta ao risco for decrescente, o que é quase unânime empiricamente, então taxação de riqueza diminui a *quantidade* do ativo arriscado
