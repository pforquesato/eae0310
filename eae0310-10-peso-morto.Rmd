...
Seja $e \left( p_0, V(p_1, Y) \right)$ (*função dispêndio*) a renda necessária para alcançar a preços iniciais $p_0$ a mesma utilidade $\bar{u} = V(p_1, Y)$ que o indivíduo tem a preços após os impostos $p_1 = p_0 + t$ (utilidade que é menor, já que $p_1 > p_0$)
...
$$EB = |EV| - R(t) = - \left( e \left( p_0, V(p_1, Y) \right) - Y \right) - t x(p_1, Y)$$ 
