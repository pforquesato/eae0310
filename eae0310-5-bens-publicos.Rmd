...
Quando bens públicos também são *não-rivais*, ou seja, o consumo por um indivíduo não diminui a quantidade disponível para os outros, então chamamos o bem de **bem público puro**
...
*Bens comuns* são bens não-excludentes que são *rivais* &mdash; pode levar ao **dilema dos comuns**: cada indivíduo tem o incentivo de consumir mais do bem do que seria socialmente ótimo, levando ao seu esgotamento
...
A forma mais simples de se pensar no dilema dos comuns é como um *dilema dos prisioneiros*
...
Na 2a metade do séc. XX acreditava-se que havia apenas duas soluções *possíveis* para o dilema dos comuns: ou o *Leviatã* ou demarcação dos comuns em *propriedade privada* &mdash; sem espaço para comunidades auto-geridas

`r Citep(myBib, "ostrom1990governing")` notou que no mundo real, comuns existem e funcionam de forma eficiente &mdash; a aplicabilidade do *dilema dos comuns* depende das circunstâncias *práticas* do ambiente analisado (*políticas públicas baseadas em metáforas*)
...
Bens públicos podem ser ofertados ao nível federal, estadual ou municipal. O que determina quais gastos devem ser realizados em qual esfera?

Tiebout (1956) propôs que uma vantagem da provisão local é que gera *competição* entre as localidades &mdash; cidadãos podem *votar com os pés*

Comunidades locais deveriam prover bens públicos que sejam para todos (*tax-benefit linkages*), com poucas externalidades espaciais e poucas economias de escala  (**federalismo fiscal ótimo**) 
