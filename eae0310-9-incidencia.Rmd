...
---
class: middle
## Incidência em mercados não-competitivos

Incidência em mercados não-competitivos é mais complicado, mas ainda assim no modelo não importa para a incidência econômica quem formalmente paga o imposto

Dizemos que o peso-morto $D$ é **de segunda-ordem** quando $\lim_{dt\rightarrow 0} \frac{D}{dt} = 0$

Como veremos na aula que vem, em *mercados competitivos* o peso-morto é de segunda ordem (negligenciável) &mdash; assim, a perda de excedente do consumidor, $\rho dt \cdot Q$ (onde $\rho$ é o **pass-through**), e a perda do produtor, $(1 - \rho)dt \cdot Q$, somam (aproximadamente) a receita do governo $R(dt) = Qdt$

---
class: middle
## Incidência em mercados não-competitivos

Quando há alguma imperfeição no mercado (no caso, poder de mercado), *o peso-morto não é mais de segunda-ordem*: então a perda de excedente do consumidor e do produtor somam **mais que** a receita do governo

De fato, a incidência no consumidor continua sendo $\rho$, pois é o aumento do preço que ele paga, $dp^c/dt$ &mdash; mas agora a incidência no produtor é $1$: o monopolista absorve um montante igual a *toda* taxação `r Citep(myBib, "weyl2013pass")`  
